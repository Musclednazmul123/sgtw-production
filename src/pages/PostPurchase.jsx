...
function st(params) {
  Axios({
    type: "get",
    url: "/merchant/shop_post_purchase?shop="+store("shop"),
    headers: {
  ...
  function DeleteOffers(){
    ...
    Axios({
      type: "delete",
      url: "/merchant/post_purchases/delete?id="+delete_offer_id+"&shop="+store("shop"),
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    return(
      <Page>
        ...
        primaryAction={{
          ...
          onAction: () => {
            navigate("/bundles/create/post-purchase", {replace: true});
            replace({pathname: '/bundles/create/post-purchase'});
          }
        }}
        secondaryActions={[
          {
      ...
      />
        <Layout>
          ...
          <Card sectioned>
          <EmptyState
            heading="Start Post-Purchase Bundles"
            action={{ 
              content: "Add Bundle",
              onAction: () => {
            navigate("/bundles/create/post-purchase", {replace: true});
          ...
          >
            <p>Start adding Post Purchase offers which loves by your customers.</p>
          </EmptyState> 
        </Card>
          </Layout.Section>
        </Layout>
                ...
                <Stack alignment="center">
                  <Stack.Item fill>
                    <TextField
                      ...
                      placeholder="Search by bundle name, tag or product title"
                    />
                  </Stack.Item>
                </Stack>
              </Stack.Item>
    ...
    <DataTable
      rows={rows.map((row) => [
        <div>
          <Toggle
            ...
            onChange={(e) => {
              ...
              Axios({
                url: `/merchant/post_purchase/status?id=${row._id}`,
                type: "put",
                data: {
                  active: active,
                  id: row._id,
        ...
        <Button
            icon={AnalyticsMajor}
            onClick={() => {
                navigate("/post-purchase/show/"+row.uid);
                replace({pathname: '/post-purchase/stats'});
            }}
          />
          <Button
            icon={EditMajor}
            onClick={() => {
              if (typeof onEditClick === "function") {
                navigate("/post_purchase/edit/"+row._id);
                replace({pathname: '/post_purchase/edit/'+row._id});
              }
            }}
          />
          <Button
